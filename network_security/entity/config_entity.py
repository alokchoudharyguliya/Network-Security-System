...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_train_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_DIR_NAME,training_pipeline.TRAIN_FILE_NAME.replace("csv","npy"))
        ...
        self.transformed_object_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_DIR_NAME,training_pipeline.PREPROCESSING_OBJECT_FILE_NAME)
