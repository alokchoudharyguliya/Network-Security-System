...
class TrainingPipeline:
    ...
    def start_model_trainer(self,data_transformation_artifact:DataTransformationArtifact):
        try:
            ...
            model_trainer=ModelTrainer(data_transformer_artifact=data_transformation_artifact,
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            aws_bucket_url=f""
            self.s3_sync.sync_folder_from_s3(self.training_pipeline_config.artifact_dir,aws_bucket_url=aws_bucket_url)
        except Exception as e:
            raise NetworkSecurityException(e,sys)
